...
puntero definicion:  file *cursor;
abro el archivo:  cursor=fopen("ventas.txt","w(write)")
carga de datos: fputs("esta es la primera linea \n","cursor")
cerrar archivo: fclose(cursor)
*/
