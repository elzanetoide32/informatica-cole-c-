////hacer el 2 pero con los datos x el txt
#include <iostream>
#include<fstream>
...
int Mostrardata()
{
    ...
    if (B > M)
    {
        ...
        archivo<< "BSAS tiene mas ventas entre 10k y 30k"<<endl;
    }
    else if (M > B)
    {
        cout << "mendoza tiene mayor ventas" << endl;
        archivo<<"mendoza tiene mas ventas entre 10k y 30k"<<endl;
    }
    else
    {
        cout << "ambas son iguales" << endl;
        archivo<<"ambas tienen la misma cantidad de ventas entre 10k y 30k"<<endl;
    }
    ...
    if (B2 > M2)
    {
        ...
        archivo<<"BSAS tiene mas ventas de 1k"<<endl;
    }
    else if (M2 > B2)
    {
        cout << "mendoza tiene mas ventas" << endl;
        archivo<<"mendoza tiene mas ventas de 1k"<<endl;
    }
    else
    {
        cout << "ambas son iguales" << endl;
        archivo<<"ambas tienen ventas de 1k"<<endl;
    }
    /////////////////////////
    for (int i = 0; i > 12; i++)
    {
    ...
    if (to > to1)
    {
        ...
        archivo <<"BSAS tiene mas ventas y un total de: "<<to<<endl;
    }
    else if (to1 > to)
    {
        cout << "mendoza tiene mas ventas y un total de: " << to1 << endl;
        archivo<<"mendoza tiene mas ventas y un total de: "<<to1<<endl;
    }
